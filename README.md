...
The C program makes use of pointers, efficient memory allocation, communication with hardware components by writing directly to pins, created libraries with my own custom methods. 
